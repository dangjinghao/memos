...
type WorkspaceSetting_MemoRelatedSetting struct {
	...
	EnableCommentContentSearch bool `protobuf:"varint,11,opt,name=enable_comment_content_search,json=enableCommentContentSearch,proto3" json:"enable_comment_content_search,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *WorkspaceSetting_MemoRelatedSetting) GetEnableCommentContentSearch() bool {
	if x != nil {
		return x.EnableCommentContentSearch
	}
	return false
}
...
const file_api_v1_workspace_service_proto_rawDesc = "" +
	...
	"\x1aGetWorkspaceProfileRequest\"\xda\x11\n" +
	...
	"\tnsfw_tags\x18\n" +
	" \x03(\tR\bnsfwTags\x12A\n" +
	"\x1denable_comment_content_search\x18\v \x01(\bR\x1aenableCommentContentSearch\"F\n" +
	"\x03Key\x12\x13\n" +
