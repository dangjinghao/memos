...
func (x *WorkspaceMemoRelatedSetting) GetEnableCommentContentSearch() bool {
	if x != nil {
...
const file_store_workspace_setting_proto_rawDesc = "" +
	...
	"\x0euse_path_style\x18\x06 \x01(\bR\fusePathStyle\"\xa4\x04\n" +
	...
	"\x1denable_comment_content_search\x18\v \x01(\bR\x1aenableCommentContentSearch*s\n" +
